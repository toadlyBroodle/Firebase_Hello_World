...
public class GoogleSignInActivity extends BaseSignInActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken(getString(R.string.arg_firebase_web_client_id))
                .requestEmail()
                .build();
        // [END config_signin]
...
public class GoogleSignInActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken(getString(R.string.dflt_web_client_id))
                .requestEmail()
                .build();
...
/*    private void handleSignInResult(GoogleSignInResult result) {
    ...
    public void signIn() {
        Log.d(TAG, "Beginning sign in");
        Intent signInIntent = Auth.GoogleSignInApi.getSignInIntent(mGoogleApiClient);
        startActivityForResult(signInIntent, RC_SIGN_IN);

        // To sign a user out call:
